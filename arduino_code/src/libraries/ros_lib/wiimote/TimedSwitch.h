...
namespace wiimote
{
  ...
  class TimedSwitch : public ros::Msg
  {
    ...
    TimedSwitch():
      switch_mode(0),
      num_cycles(0),
      pulse_pattern_length(0), st_pulse_pattern(), pulse_pattern(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "wiimote/TimedSwitch"; };
    virtual const char * getMD5() override { return "e4c8d9327409cef6066fa6c368032c1e"; };
